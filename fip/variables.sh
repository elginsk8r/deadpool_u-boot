...
declare BL33_TOOLCHAIN2=${LOCAL_PATH}/../../amlogic/linaro/gcc-linaro-7.3.1-2018.05-i686_aarch64-elf/bin/aarch64-elf-
...
declare BL33_DEFCFG2="${UBOOT_FOLDER}/${DEFCFG_FOLDER}"
