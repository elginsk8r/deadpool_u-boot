...
/*
 * board/amlogic/a1_korlan_b1/firmware/timing.c
 *
...
#if 0
{ /*Temporarily open this configuration, korlan-proto uses ddr3*/
	/* ddr3 */
...
#endif
{
	...
	.ac_trace_delay			= {32,32,32,32,32,32,32,32,32,32},
	.ac_pinmux	            = {10,6,8,14,5,12,3,9,7,22,1,2,11,20,0,0,0,19,25,13,0,18,26,24,4,0,0,0},
	.dfi_pinmux				= {7,13,3,0,1,4,2,22,0,19,15,17,23,14,21,12,18,16,5,10,11,20,8,0,0,0},
	//16bit
	.ddr_dmc_remap			= {
