...
/*
 * board/amlogic/a1_korlan_p1/a1_korlan_p1
 *
...
int board_late_init(void)
{
	...
	/*GPIOP_1: output-high, enable USB protection IC and pogo USB boot*/
	gpio_option("GPIOP_1", GPIOD_IS_OUT, true);
	...
	gpio_option("GPIOA_5", GPIOD_IS_OUT, false);
	gpio_option("GPIOF_11", GPIOD_IS_OUT, false);
	gpio_option("GPIOP_3", GPIOD_IS_OUT, false);
