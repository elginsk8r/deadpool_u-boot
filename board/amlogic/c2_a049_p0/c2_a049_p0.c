...
int do_get_a049_hw_id(cmd_tbl_t *cmdtp, int flag, int argc,
		char * const argv[])
{
...
U_BOOT_CMD(
	get_a049_hw_id, 1, 0, do_get_a049_hw_id,
	"get a049 HW_ID and env_set 'hw_id'\n",
	"get_a049_hw_id"
);
