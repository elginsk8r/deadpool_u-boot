...
/*
 * board/amlogic/configs/sm1_ac232_v1.h
 *
 * Copyright (C) 2020 Amlogic, Inc. All rights reserved.
 *
 */

#ifndef __SM1_AC232_V1_H__
#define __SM1_AC232_V1_H__
...
#define CONFIG_VCCK_INIT_VOLTAGE	990		// VCCK power up voltage
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"boot_flag=0\0"\
        ...
        "initargs="\
            "init=/init " CONFIG_KNL_LOG_LEVEL " console=ttyS0,115200 no_console_suspend earlyprintk=aml-uart,0xff803000 ramoops.pstore_en=1 ramoops.record_size=0x8000 ramoops.console_size=0x4000 loop.max_part=4 "\
            "\0"\
        "upgrade_check="\
	...
	"setenv bootargs ${initargs} hdr_policy=${hdr_policy}  hdr_priority=${hdr_priority} "\
		...
		"outputmode=${outputmode} vout=${outputmode},${vout_init} "\
		...
		"video_reverse=${video_reverse} irq_check_en=${Irq_check_en} "\
		"jtag=${jtag}; "\
        ...
        "init_display="\
            ...
            "else "\
                ...
                "run storeargs;"\
                "hdmitx hpd;hdmitx get_parse_edid;setenv dolby_status 0;setenv dolby_vision_on 0;osd open;osd clear;imgread pic logo bootup $loadaddr;bmp display $bootup_offset;bmp scale;vout output ${outputmode};vpp hdrpkt;"\
            "fi;fi;"\
            "\0"\
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                ...
                "else "\
					"setenv bootconfig ${bootconfig} "\
					"androidboot.serialno=ac232${cpu_id};"\
					"setenv serial ac232${cpu_id};"\
                "fi;"\
				...
				"setenv bootconfig ${bootconfig} androidboot.oem.key1=${oemkey};"\
                "fi;"\
            "fi;"\
...
#define CONFIG_DEVICE_PRODUCT	"newton_hybrid"
