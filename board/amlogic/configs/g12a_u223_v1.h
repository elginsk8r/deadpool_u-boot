...
/*
 * board/amlogic/configs/g12a_u223_v1.h
 *
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"setenv bootargs ${initargs} phy_idx=${phy_idx} hdr_policy=${hdr_policy} "\
		...
		"video_reverse=${video_reverse} androidboot.selinux=${EnableSelinux} "\
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                "if keyman read usid ${loadaddr} str; then "\
                    ...
                    "setenv serial ${usid};"\
                "else "\
					"setenv bootargs ${bootargs} androidboot.serialno=u223${cpu_id};"\
					"setenv serial u223${cpu_id};"\
                "fi;"\
...
//For secure boot v3, need to rename this value to CONFIG_AML_SIGNED_UBOOT
