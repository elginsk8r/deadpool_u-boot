...
/*
 * deadpool shares the g12a_u212_v1 BSP code, which also serves sm1 ac213;
 * both voltage symbols must stay defined for firmware/timing.c and
 * firmware/scp_task/pwr_ctrl.c.
 */
#define CONFIG_VDDEE_INIT_VOLTAGE	840		// deadpool VDDEE voltage setting
...
#define CONFIG_IR_REMOTE_POWER_UP_KEY_VAL6 0xe7187788
#define CONFIG_IR_REMOTE_POWER_UP_KEY_VAL7 0xde217788
	...
	"setenv bootargs ${initargs} phy_idx=${phy_idx} hdr_policy=${hdr_policy} "\
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                ...
                "else "\
					"setenv bootconfig ${bootconfig} "\
					"androidboot.serialno=u212${cpu_id};"\
					"setenv serial u212${cpu_id};"\
                "fi;"\
