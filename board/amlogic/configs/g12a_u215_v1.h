...
/*
 * board/amlogic/configs/g12a_u215_v1.h
 *
 * Copyright (C) 2020 Amlogic, Inc. All rights reserved.
 *
 */

#ifndef __G12A_U215_V1_H__
#define __G12A_U215_V1_H__
	...
	"boot_flag=0\0"\
        ...
        "cmdline_keys="\
            "if keyman init 0x1234; then "\
                ...
                "else "\
					"setenv bootconfig ${bootconfig} "\
					"androidboot.serialno=u215${cpu_id};"\
					"setenv serial u215${cpu_id};"\
                "fi;"\
...
#define CONFIG_DEVICE_PRODUCT	"franklin_hybrid"
