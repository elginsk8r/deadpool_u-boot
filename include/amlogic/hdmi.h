...
struct hdmitx_dev {
	...
	/* edid parsing data */
	struct rx_cap RXCap;
	/* HDMI Parameter information */
	struct hdmi_format_para *para;
	/* Hdmi_vic Information */
	enum hdmi_vic vic;
	/* Refresh rate, 0 represents an integer; 1 represents decimals */
	...
	bool config_csc_en;
	/* HPD status information, false: device is disconnected; true: device is connected */
	bool hpd_state;
};
...
int hdmitx_likely_frac_rate_mode(char *mode);
