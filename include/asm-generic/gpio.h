...
/**
 * gpio_option() - Set the specified gpio pin in/out, and high/low(out)
 * @gpiopin: eg: GPIOA_5
 * @dir: GPIOD_IS_OUT/GPIOD_IS_IN
 * @enable: true --> 1, false --> 0
 * */
int gpio_option(const char* gpiopin, int dir, bool enable);
#endif /*AML GPIO OPTION*/
