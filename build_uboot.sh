...
function usage(){
  ...
  echo "                  legion-p1"
  echo "                  puddy-p0"
  echo "                  elaine-p0, elaine-p1"
  echo "                  nq-p2, nq-b1, nq-b3, nq-b4"
  echo "                  gq-p2, gq-b1, gq-b3, gq-b4"
}
...
case $board in
  ...
  nq-p2)
    ...
    ;;
  nq-b1|nq-b3)
    building_uboot c1 c1_nq bx $board $dbg_flag
    ;;
  nq-b4)
    export ENABLE_UBOOT_UPDATE=0
  ...
  gq-p2)
    ...
    ;;
  gq-b1|gq-b3)
    building_uboot c1 c1_gq bx $board $dbg_flag
    ;;
  gq-b4)
    export ENABLE_UBOOT_UPDATE=0
    export ENABLE_PRODUCTION_MODE=1
