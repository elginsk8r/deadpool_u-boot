...
RE_RSV_INFO:
	...
	pr_debug("%s blk = %d, ec = %d, page = %d, timestamp = %d\n",
	...
	temp_node = rsv_info->nfree;
	while (temp_node) {
		pr_debug("block num = %d, ec = %d, dirty_flag = %d\n",
			temp_node->blk_addr,
			temp_node->ec,
