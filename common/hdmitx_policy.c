...
{
	char *user_cs = getenv("user_colorattribute");
...
int get_hdr_strategy_priority(void)
{
	...
	hdr_strategy_priority = getenv_ulong("hdr_priority", 10, ~0UL);
...
{
	char *hdr_policy = getenv("hdr_policy");
...
{
	char *hdr_force_mode = getenv("hdr_force_mode");
	int force_mode = 0;
...
int get_ubootenv_dv_type(void)
{
	...
	dv_type = getenv("user_prefer_dv_type");
